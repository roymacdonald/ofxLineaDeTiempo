...
//	
//	
////	_scrollListeners.push(_clippingPanel->vZoomUpdated.newListener(this, &ScrollablePanel_<H, D, B, C, CT>::_clippingPanelScrollVChanged));
////	_scrollListeners.push(_clippingPanel->hZoomUpdated.newListener(this, &ScrollablePanel_<H, D, B, C, CT>::_clippingPanelScrollHChanged));
//	
//	
//	
...
////
////template<typename H, typename D,  template <typename, typename> class B, typename C, typename CT>
////void ScrollablePanel_<H, D, B, C, CT>::_clippingPanelScrollVChanged(D& s)
////{
////	setScrollV(s);
////}
////
////
////template<typename H, typename D,  template <typename, typename> class B, typename C, typename CT>
////void ScrollablePanel_<H, D, B, C, CT>::_clippingPanelScrollHChanged(D& s)
////{
////	setScrollH(s);
////}
//
