...
meta:
	ADDON_NAME = ofxLineaDeTiempo
	ADDON_DESCRIPTION = A new timeline addon for openframeworks.
	ADDON_AUTHOR = @roymacdonald
	ADDON_TAGS = "addon" "timeline"
	ADDON_URL = http://github.com/roymacdonald/ofxLineaDeTiempo

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxPointer ofxGui
