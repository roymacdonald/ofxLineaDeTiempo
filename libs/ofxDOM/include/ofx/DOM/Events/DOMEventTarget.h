...
template <class EventTargetType>
DOMEventTarget<EventTargetType>::DOMEventTarget()
{
...
template <class EventTargetType>
template <class EventType>
bool DOMEventTarget<EventTargetType>::dispatchEvent(EventType& event)
{
...
template <class EventTargetType>
bool DOMEventTarget<EventTargetType>::hasListenersForEventType(const std::string& type) const
{
...
template <class EventTargetType>
template <class EventArgsType>
bool DOMEventTarget<EventTargetType>::handleEvent(EventArgsType& e)
{
...
template <class EventTargetType>
bool DOMEventTarget<EventTargetType>::isEventTypeRegistered(const std::string& type) const
{
...
template <class EventTargetType>
void DOMEventTarget<EventTargetType>::registerEventType(const std::string& type,
														BaseDOMEvent* event)
{
...
template <class EventTargetType>
void DOMEventTarget<EventTargetType>::unregisterEventType(const std::string& type)
{
