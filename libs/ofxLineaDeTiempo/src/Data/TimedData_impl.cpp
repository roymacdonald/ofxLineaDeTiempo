...
#include "src/Data/KeyframedParameter.cpp"
...
//-----------------------------------------------------------------------------
#ifdef ENABLE_OF_RECTANGLE_TIMED_DATA
template class KeyframedParameter_<ofRectangle>;
#endif

template class KeyframedParameter_<ofColor_<char>>;
template class KeyframedParameter_<ofColor_<unsigned char>>;
template class KeyframedParameter_<ofColor_<short>>;
template class KeyframedParameter_<ofColor_<unsigned short>>;
template class KeyframedParameter_<ofColor_<int>>;
template class KeyframedParameter_<ofColor_<unsigned int>>;
template class KeyframedParameter_<ofColor_<long>>;
template class KeyframedParameter_<ofColor_<unsigned long>>;
template class KeyframedParameter_<ofColor_<float>>;
#ifdef ENABLE_OF_COLOR_DOUBLE_TIMED_DATA
template class KeyframedParameter_<ofColor_<double>>;
#endif

template class KeyframedParameter_<glm::vec2>;
template class KeyframedParameter_<glm::vec3>;
template class KeyframedParameter_<glm::vec4>;
#ifdef ENABLE_GLM_QUAT_MAT_TIMED_DATA
template class KeyframedParameter_<glm::quat>;
template class KeyframedParameter_<glm::mat4>;
#endif


template class KeyframedParameter_<char>;
template class KeyframedParameter_<unsigned char>;
template class KeyframedParameter_<short>;
template class KeyframedParameter_<unsigned short>;
template class KeyframedParameter_<int>;
template class KeyframedParameter_<unsigned int>;
template class KeyframedParameter_<long>;
template class KeyframedParameter_<unsigned long>;
template class KeyframedParameter_<float>;
template class KeyframedParameter_<double>;
#ifdef ENABLE_LONG_DOUBLE_TIMED_DATA
template class KeyframedParameter_<long double>;
#endif
